...
function ENT:DecorateSelf()
	...
	tubes:SetModel( "models/props_halloween/flask_vial.mdl" )
	tubes:SetPos( self:GetPos() - self:GetAngles():Forward() * 3.5 + self:GetAngles():Up() * 28 - self:GetAngles():Right() * 18 )
	...
	flask:SetModel( "models/props_halloween/flask_bottle.mdl" )
	flask:SetPos( self:GetPos() - self:GetAngles():Forward() * 8.6 + self:GetAngles():Up() * 33 + self:GetAngles():Right() * 4.5 )
